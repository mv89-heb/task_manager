...
def test_register_without_email_or_phone(client, db_session):
    ...
    r = client.post("/register", data={"username": "noemail_user", "password": "StrongPass1"}, follow_redirects=True)
...
def test_register_with_phone_only(client, db_session):
    ...
    client.post("/register", data={"username": "phoneonly_user", "phone": "0501234567", "password": "StrongPass1"})
